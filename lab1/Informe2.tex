...
Enunciado: Ejecutar el Arduino IDE. Investigue acerca de los pasos que debe seguir para seleccionar
...
Utilizando el protoboard, construya un circuito con una resistencia de protección
...
Enunciado: Modifique el circuito anterior conectando un pulsador en el pin digital~2 y modifique el
